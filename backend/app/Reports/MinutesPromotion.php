...
class MinutesPromotion
{
     ...
     * @throws \Exception
     */
    public static function getFinalSavannas(Request $request): JsonResponse
    {
     ...
     * @throws \Exception
     */
    public static function getMinutesPromotionStatistics(Request $request): JsonResponse
    {
        $school     = SchoolQueries::getSchoolRequest($request);
        $year       = $school->year;
     ...
     * @throws \Exception
     */
    public static function getMinutesPromotion(Request $request): JsonResponse
    {
        $school     = SchoolQueries::getSchoolRequest($request);
        $year       = $school->year;
        $report	    = 'actas_promocion';
        $query	    = "CALL sp_select_acta_promocion('".$school->grade."','".$school->group."',".$school->workingDay.
            ",".$school->headquarter.",".$year.")";
