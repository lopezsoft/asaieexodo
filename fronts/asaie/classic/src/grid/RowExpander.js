 ...
 */
Ext.define('Admin.grid.RowExpander', {
    ...
    rowBodyTpl: [
        '<div class="text-wrapper">',
            '<div class="news-data">',
                '<div class="news-paragraph">{comment_activity}</div>',
                '<div class="news-toggle collapse"><span>CERRAR</span><img src="resources/icons/collapse-news.png"></div>',
            '</div>',
        '</div>'
    ],
