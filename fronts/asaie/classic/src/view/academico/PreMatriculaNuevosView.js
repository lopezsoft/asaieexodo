 ...
 */
Ext.define('Admin.view.academico.PreMatriculaNuevosView',{
    extend  : 'Admin.base.WindowCrud',
    alias   : 'widget.PreMatriculaNuevosView',
    itemId  : 'PreMatriculaNuevosView',
    title   : 'Ficha Pre-Matricula Nuevos',
    initComponent: function () {
        ...
        me.onStore('general.PreMatriculaNuevosStore');
                            ...
                            items   : [
                                ...
                                },'-',
								{
									...
									handler	: function (btn) {
                                        win	= Ext.create('Admin.view.academico.ConfirmarNuevosView');
                                        win.show();
									}
								},'->',
                                {
