Ext.define('Admin.view.charts.home.RegisteredBar', {
    ...
    title: AppLang.getSTitleStudentRegistered(),
    ...
    items: [
        {
                    ...
                    tooltip: {
                        ...
                        renderer: function(tooltip, record, item) {
                            tooltip.setHtml(record.get('year') + ': ' +
                                Ext.util.Format.number(record.get('total'), '0,000 (' + AppLang.getSTitleStudentRegistered()+')'));
                        }
                    },
            ...
            sprites: [
                {
                    type: 'text',
                    text: AppLang.getSTitleStudentRegistered(),
                    fontSize: 22,
                    width: 100,
                    height: 40,
