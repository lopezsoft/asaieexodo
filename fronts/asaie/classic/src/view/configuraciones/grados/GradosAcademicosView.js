...
Ext.define('Admin.view.configuraciones.GradosAcademicosView',{
    extend  		: 'Admin.base.WindowCrud',
    title   		: 'Grados académicos',
    controller  	: 'configuraciones',
	alias       	: 'widget.gradosAcademicosView',
    items       : [
        {
			xtype   		: 'customform',
			showUndoButton 	: true,
							...
							handler: function (grid, rowIndex, colIndex) {
								...
								me.onStore('general.NivelesAcademicosStore');
									var
										...
										win2	= Ext.create('Admin.view.configuraciones.NivelesAcademicosListView'),
										form	= win2.down('form');
									if (btn1.isDisabled()) {
						...
						dell: {
							...
							handler: function (grid, rowIndex, colIndex) {
								var	win		= grid.up('window'),
									rec 	= grid.getStore().getAt(rowIndex),
									me	= Admin.getApplication();
								me.onRecordDelete(rec,'GradosStore');
							}
						}
					},
                    plugins: [
