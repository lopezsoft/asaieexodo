Ext.define('Admin.view.docentes.EvaluationCoursesStudents',{
    extend          : 'Ext.panel.Panel',
    alias  	        : 'widget.studentsbyevaluationcourses',
    config          :  {
        evaluationId    : 0,
        evaluationName  : '',
        courseId        : 0,
    ...
    initComponent   : function(){
        ...
        if(!me.getEvaluationId() > 0){
            ...
            let studentsbyevaluationcoursesstore  = Ext.create('Admin.store.base.StoreUrl',{
            ...
            me.items    = [
                {
                    xtype       : 'dataview',
                    store       : studentsbyevaluationcoursesstore,
                    liveDrag    : true,
                        ...
                        '<tpl for=".">',
                            ...
                            '<div class="thumb">',
                                ...
                                '<div class="thumb-icon-student"></div>',
                                    ...
                                    '</div>',
                                    '<a class="thumb-return" href="#evaluationcourses" target="_self"></a>',
                                '</div>',
                            '</div>',
                        '</tpl>'
                    ]
