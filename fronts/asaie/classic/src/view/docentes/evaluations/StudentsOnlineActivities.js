Ext.define('Admin.view.docentes.StudentsOnlineActivities',{
    extend          : 'Ext.panel.Panel',
    alias  	        : 'widget.studentsonlineactivities',
    config          :  {
        activityId      : 0,
        activityName    : '',
        courseId        : 0,
    ...
    initComponent   : function(){
        ...
        if(!me.getActivityId() > 0){
            ...
            me.items    = [
                {
                    xtype       : 'dataview',
                    store       : studentsonlineactivitiesstore,
                    liveDrag    : true,
                        ...
                        '<tpl for=".">',
                            ...
                            '<div class="thumb">',
                                ...
                                '<div class="thumb-icon-student"></div>',
                                    ...
                                    '</div>',
                                    '<a class="thumb-return" href="#activitiescourses" target="_self"></a>',
                                '</div>',
                            '</div>',
                        '</tpl>'
                    ]
