...
import { JqxCustomGridComponent } from './../../data/custom-grid/jqx-custom-grid.component';

@Injectable()
export class FormGridComponent extends JqxCustomGridComponent implements OnInit, AfterViewInit {
